...
<body class="p-3 m-0 border-0 bd-example" style="background-image: url(FONDOS/Fondo50.jpg);">
    ...
    <div class="container" style="color:white" ;>
        ...
        <br>
        <h2 style="text-align: center; color:white;">Tabla Solicitudes</h2>
        <table class="table" style="color:white;">
            ...
            if (isset($_GET['btns'])) {
                ...
                $query = "SELECT * FROM solicitudes WHERE Id LIKE '$Buscar'";
                ...
                if (mysqli_num_rows($conn) > 0) {
                    while ($vec = mysqli_fetch_array($conn)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href='frmActSolicitudes.php?id=<?php echo $vec[0] ?>'><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href=""><i class="fa-sharp fa-solid fa-trash"></i></i></a>
                            </td>
                        </tr>
            <?php }
                } else {
                    echo "No se encontraron datos para la búsqueda";
                }
            } else {
