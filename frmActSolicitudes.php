    ...
    <div class="container my-3">
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <h2 class="centrado">Actualizar Solicitudes</h2>
                ...
                <form action="RegSolicitudes.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="fecha" id="fecha" value="<?php echo $vec[1] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="precio">Precio:</label>
                        <input type="number" name="precio" id="precio" value="<?php echo $vec[2] ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="observ">Observación:</label>
                        <input type="text" name="observ" id="observ" value="<?php echo $vec[3] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="estado" id="estado" value="<?php echo $vec[6] ?>" class="form-control">
                    </div>
